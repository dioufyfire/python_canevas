class Atome:
    "anatomes simplifiés, choisis parmi les 10 premiers éléments du TP"
    table =[None, ('hydrogène',0), ('hélium', 2), ('lithium', 4),
    ('beryllium',5), ('bore', 6), ('carbone', 6), ('azote',7),
    ('oxygène', 8), ('fluor', 10), ('néon', 10)]

    def __init__(self, nat):
        "le nº atomique détermine le n. de protons, d'électrons et de neutrons"
...
class Ion(Atome):
    ...
    def __init__(self, nat, charge):
        "le nº atomique et la charge électrique déterminent l'ion"
